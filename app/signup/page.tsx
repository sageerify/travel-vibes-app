...
import { MapPin, Eye, EyeOff, Mountain, Camera, User } from "lucide-react"
...
const roles = [
  {
    id: "tourist",
    label: "Tourist",
    description: "Discover local guides and photographers",
    icon: User,
  },
  {
    id: "guide",
  ...
  },
  {
    id: "photographer",
    label: "Photographer",
    description: "Capture memorable moments for tourists",
    icon: Camera,
  },
]
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Join the Travel Vibes community today
          </CardDescription>
        </CardHeader>
        <CardContent>
